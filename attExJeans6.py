...
GOOGLE_API_KEY = "AIzaSyB38PSGkCLpLlSzQ7fnCHC4KHDYHOu3KDk"
...
| Marketplace           |     Iconic      |
    ...
    try:
        ...
        tokens_per_image = input_tokens / len(file_names) if file_names else 0
        print(f"Tokens Used Per Image: {tokens_per_image}")
        return content
...
def main():
    ...
    output_csv = "output_Full_Jeans_6.csv"
    ...
    output_csv = "Sheet_present_Jeans_6.csv"
